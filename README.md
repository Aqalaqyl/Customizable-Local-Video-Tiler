...
Click any item in a tile's playlist to play it in that tile. Multiple tiles can
play at once, so you can monitor several videos side by side or keep audio going
in one pane while watching another.
